...
backgroundImg.src = 'assets/models/backgroundBase.jpg'

const playerImg = new Image();
playerImg.src = 'assets/models/Fantasma.png';

const cofreImg = new Image();
cofreImg.src = 'assets/models/cofre.png'

const bedImg = new Image();
bedImg.src = 'assets/models/bed.png'

const desktImg = new Image();
desktImg.src = 'assets/models/desktop.png'

const tvTopImg = new Image();
tvTopImg.src = 'assets/models/tvTop.png'
const tvBotImg = new Image();
tvBotImg.src = 'assets/models/tvBot.png'

const shelvTopImg = new Image();
shelvTopImg.src = 'assets/models/shelvTop.png'
const shelvBotImg = new Image();
shelvBotImg.src = 'assets/models/shelvBot.png'

const closetTopImg = new Image();
closetTopImg.src = 'assets/models/closetTop.png'
const closetBotImg = new Image();
closetBotImg.src = 'assets/models/closetBot.png'

const sofaTopImg = new Image();
sofaTopImg.src = 'assets/models/sofaTop.png'
const sofaBotImg = new Image();
sofaBotImg.src = 'assets/models/sofaBot.png'
